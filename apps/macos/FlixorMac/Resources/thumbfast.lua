...
local function info(w, h)
    ...
    -- Set user-data property for external observers (like our Swift integration)
    mp.set_property("user-data/thumbfast-info", json)

    -- Also send script-message for compatibility
    if pre_0_30_0 then
